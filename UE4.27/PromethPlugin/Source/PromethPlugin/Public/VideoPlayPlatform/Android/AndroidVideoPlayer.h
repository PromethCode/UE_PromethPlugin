...
class PROMETHPLUGIN_API AndroidVideoPlayer:public IVideoPlayer
{
public:
	AndroidVideoPlayer();
...
public:
	...
	static TMap<FString, AndroidCallBackParam> OpenCallBackParam;
};
