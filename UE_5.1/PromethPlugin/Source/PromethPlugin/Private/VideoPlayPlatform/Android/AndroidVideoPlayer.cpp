...
void AndroidVideoPlayer::OpenVideo(FString VideoPath, TFunction<void(bool OpenSucceed, FString ID)> OpenVideoCallBackFun)
{
	...
	UCPromethBlueprintLib::PromethDebug("OpenVideoAPI Begin!", IVideoPlayer::VideoPlayerDebug, "OpenVideo");

	if(this->OpenVideoAPI) OpenVideoAPI(TCHAR_TO_UTF8(*VideoPath), ID, this->OpenVideoCallBack);
	else UCPromethBlueprintLib::PromethDebug("OpenVideoAPI is Nullptr!!!!!!!!!!!!!!!!!!", IVideoPlayer::VideoPlayerDebug, "OpenVideo", false, 20.f, FColor::Red);

	UCPromethBlueprintLib::PromethDebug("OpenVideoAPI End!", IVideoPlayer::VideoPlayerDebug, "OpenVideo");
