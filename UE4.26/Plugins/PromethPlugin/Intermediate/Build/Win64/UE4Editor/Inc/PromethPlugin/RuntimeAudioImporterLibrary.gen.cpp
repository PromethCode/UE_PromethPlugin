...
#include "PromethPlugin/Public/AudioModel/RuntimeAudioImporterLibrary.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	PROMETHPLUGIN_API UClass* Z_Construct_UClass_URuntimeAudioImporterLibrary();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
	PROMETHPLUGIN_API UEnum* Z_Construct_UEnum_PromethPlugin_EAudioFormat();
	PROMETHPLUGIN_API UClass* Z_Construct_UClass_UPreImportedSoundAsset_NoRegister();
	PROMETHPLUGIN_API UEnum* Z_Construct_UEnum_PromethPlugin_ERAWAudioFormat();
// End Cross Module References
	struct Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics
	{
	...
	void Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit(void* Obj)
	{
		((_Script_PromethPlugin_eventOnRAWDataTranscodeFromFileResult_Parms*)Obj)->bSucceeded = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::NewProp_bSucceeded = { "bSucceeded", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_PromethPlugin_eventOnRAWDataTranscodeFromFileResult_Parms), &Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::NewProp_bSucceeded,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PromethPlugin, nullptr, "OnRAWDataTranscodeFromFileResult__DelegateSignature", nullptr, nullptr, sizeof(_Script_PromethPlugin_eventOnRAWDataTranscodeFromFileResult_Parms), Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics
	{
	...
	void Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit(void* Obj)
	{
		((_Script_PromethPlugin_eventOnRAWDataTranscodeFromBufferResult_Parms*)Obj)->bSucceeded = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_bSucceeded = { "bSucceeded", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_PromethPlugin_eventOnRAWDataTranscodeFromBufferResult_Parms), &Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData_Inner = { "RAWData", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData_MetaData[] = {
		{ "DisplayName", "RAW Data" },
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData = { "RAWData", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PromethPlugin_eventOnRAWDataTranscodeFromBufferResult_Parms, RAWData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_bSucceeded,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::NewProp_RAWData,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PromethPlugin, nullptr, "OnRAWDataTranscodeFromBufferResult__DelegateSignature", nullptr, nullptr, sizeof(_Script_PromethPlugin_eventOnRAWDataTranscodeFromBufferResult_Parms), Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromBufferResult__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics
	{
	...
	void Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit(void* Obj)
	{
		((_Script_PromethPlugin_eventOnAudioExportToFileResult_Parms*)Obj)->bSucceeded = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::NewProp_bSucceeded = { "bSucceeded", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_PromethPlugin_eventOnAudioExportToFileResult_Parms), &Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::NewProp_bSucceeded,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PromethPlugin, nullptr, "OnAudioExportToFileResult__DelegateSignature", nullptr, nullptr, sizeof(_Script_PromethPlugin_eventOnAudioExportToFileResult_Parms), Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToFileResult__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics
	{
	...
	void Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit(void* Obj)
	{
		((_Script_PromethPlugin_eventOnAudioExportToBufferResult_Parms*)Obj)->bSucceeded = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_bSucceeded = { "bSucceeded", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_PromethPlugin_eventOnAudioExportToBufferResult_Parms), &Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_bSucceeded_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData_Inner = { "AudioData", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData = { "AudioData", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PromethPlugin_eventOnAudioExportToBufferResult_Parms, AudioData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_bSucceeded,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::NewProp_AudioData,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PromethPlugin, nullptr, "OnAudioExportToBufferResult__DelegateSignature", nullptr, nullptr, sizeof(_Script_PromethPlugin_eventOnAudioExportToBufferResult_Parms), Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PromethPlugin_OnAudioExportToBufferResult__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics
	{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_Importer = { "Importer", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PromethPlugin_eventOnAudioImporterResult_Parms, Importer), Z_Construct_UClass_URuntimeAudioImporterLibrary_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_ImportedSoundWave = { "ImportedSoundWave", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PromethPlugin_eventOnAudioImporterResult_Parms, ImportedSoundWave), Z_Construct_UClass_UImportedSoundWave_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_Status_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_Status = { "Status", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PromethPlugin_eventOnAudioImporterResult_Parms, Status), Z_Construct_UEnum_PromethPlugin_ETranscodingStatus, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_Importer,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_ImportedSoundWave,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_Status_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::NewProp_Status,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PromethPlugin, nullptr, "OnAudioImporterResult__DelegateSignature", nullptr, nullptr, sizeof(_Script_PromethPlugin_eventOnAudioImporterResult_Parms), Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics
	{
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::NewProp_Percentage = { "Percentage", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PromethPlugin_eventOnAudioImporterProgress_Parms, Percentage), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::NewProp_Percentage,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PromethPlugin, nullptr, "OnAudioImporterProgress__DelegateSignature", nullptr, nullptr, sizeof(_Script_PromethPlugin_eventOnAudioImporterProgress_Parms), Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_ExportSoundWaveToFile_Statics::NewProp_AudioFormat = { "AudioFormat", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventExportSoundWaveToFile_Parms, AudioFormat), Z_Construct_UEnum_PromethPlugin_EAudioFormat, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_GetAudioFormat_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventGetAudioFormat_Parms, ReturnValue), Z_Construct_UEnum_PromethPlugin_EAudioFormat, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromRAWBuffer_Statics::NewProp_RAWFormat = { "RAWFormat", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventImportAudioFromRAWBuffer_Parms, RAWFormat), Z_Construct_UEnum_PromethPlugin_ERAWAudioFormat, METADATA_PARAMS(Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromRAWBuffer_Statics::NewProp_RAWFormat_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromRAWBuffer_Statics::NewProp_RAWFormat_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer_Statics::NewProp_RAWFormatFrom = { "RAWFormatFrom", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventTranscodeRAWDataFromBuffer_Parms, RAWFormatFrom), Z_Construct_UEnum_PromethPlugin_ERAWAudioFormat, METADATA_PARAMS(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer_Statics::NewProp_RAWFormatFrom_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer_Statics::NewProp_RAWFormatFrom_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer_Statics::NewProp_RAWFormatTo = { "RAWFormatTo", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventTranscodeRAWDataFromBuffer_Parms, RAWFormatTo), Z_Construct_UEnum_PromethPlugin_ERAWAudioFormat, METADATA_PARAMS(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer_Statics::NewProp_RAWFormatTo_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer_Statics::NewProp_RAWFormatTo_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_RAWFormatFrom = { "RAWFormatFrom", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventTranscodeRAWDataFromFile_Parms, RAWFormatFrom), Z_Construct_UEnum_PromethPlugin_ERAWAudioFormat, METADATA_PARAMS(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_RAWFormatFrom_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_RAWFormatFrom_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_RAWFormatTo = { "RAWFormatTo", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventTranscodeRAWDataFromFile_Parms, RAWFormatTo), Z_Construct_UEnum_PromethPlugin_ERAWAudioFormat, METADATA_PARAMS(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_RAWFormatTo_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_RAWFormatTo_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeAudioImporterLibrary_eventTranscodeRAWDataFromFile_Parms, Result), Z_Construct_UDelegateFunction_PromethPlugin_OnRAWDataTranscodeFromFileResult__DelegateSignature, METADATA_PARAMS(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile_Statics::NewProp_Result_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ConvertSecondsToString, "ConvertSecondsToString" }, // 4229738340
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_CreateRuntimeAudioImporter, "CreateRuntimeAudioImporter" }, // 3144085790
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ExportSoundWaveToBuffer, "ExportSoundWaveToBuffer" }, // 4042057190
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ExportSoundWaveToFile, "ExportSoundWaveToFile" }, // 1769174267
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_GetAudioFormat, "GetAudioFormat" }, // 1927629586
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_GetAudioFormatAdvanced, "GetAudioFormatAdvanced" }, // 3709776911
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromBuffer, "ImportAudioFromBuffer" }, // 4126137754
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromFile, "ImportAudioFromFile" }, // 3767061013
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromPreImportedSound, "ImportAudioFromPreImportedSound" }, // 592801886
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromRAWBuffer, "ImportAudioFromRAWBuffer" }, // 2019566441
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_ImportAudioFromRAWFile, "ImportAudioFromRAWFile" }, // 1729189894
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromBuffer, "TranscodeRAWDataFromBuffer" }, // 3587339491
		{ &Z_Construct_UFunction_URuntimeAudioImporterLibrary_TranscodeRAWDataFromFile, "TranscodeRAWDataFromFile" }, // 2817331382
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "IncludePath", "AudioModel/RuntimeAudioImporterLibrary.h" },
		{ "ModuleRelativePath", "Public/AudioModel/RuntimeAudioImporterLibrary.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::NewProp_OnProgress = { "OnProgress", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URuntimeAudioImporterLibrary, OnProgress), Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterProgress__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::NewProp_OnProgress_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::NewProp_OnProgress_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::NewProp_OnResult = { "OnResult", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URuntimeAudioImporterLibrary, OnResult), Z_Construct_UDelegateFunction_PromethPlugin_OnAudioImporterResult__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::NewProp_OnResult_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URuntimeAudioImporterLibrary_Statics::NewProp_OnResult_MetaData)) };
	...
	IMPLEMENT_CLASS(URuntimeAudioImporterLibrary, 4071195995);
	template<> PROMETHPLUGIN_API UClass* StaticClass<URuntimeAudioImporterLibrary>()
	{
		return URuntimeAudioImporterLibrary::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_URuntimeAudioImporterLibrary(Z_Construct_UClass_URuntimeAudioImporterLibrary, &URuntimeAudioImporterLibrary::StaticClass, TEXT("/Script/PromethPlugin"), TEXT("URuntimeAudioImporterLibrary"), false, nullptr, nullptr, nullptr);
